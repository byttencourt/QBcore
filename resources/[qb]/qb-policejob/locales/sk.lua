local Translations = {
    ...
    info = {
        ...
        on_duty = '[E~s~] - Ísť do služby',
        off_duty = '[~r~E~s~] - Ísť mimo službu',
        onoff_duty = 'On~s~/~r~Off~s~ Duty',
        stash = 'Úložisko %{value}',
        delete_spike = '[~r~E~s~] Odstrániť Spajky',
        close_camera = 'Zatvoriť kameru',
        bullet_casing = '[G~s~] Nábojnica %{value}',
        casing = 'Nábojnica',
        blood = 'Krv',
        blood_text = '[G~s~] Krv %{value}',
        fingerprint_text = '[G~s~] Odtlačok Prsta',
        fingerprint = 'Odtlačok Prsta',
        store_heli = '[E~s~] Uložiť helikoptéru',
        take_heli = '[E~s~] Vybrať helikoptéru',
        impound_veh = '[E~s~] - Vybrať vozidlo',
        store_veh = '[E~s~] - Vložiť vozidlo',
        armory = 'Zbrojnica',
        enter_armory = '[E~s~] Zbrojnica',
        finger_scan = 'Skenovanie odtlačku prsta',
        scan_fingerprint = '[E~s~] Skenovanie odtlačku prsta',
        trash = 'Smetie',
        trash_enter = '[E~s~] Odpadkový kôš',
        stash_enter = '[E~s~] Otvoriť úložisko',
