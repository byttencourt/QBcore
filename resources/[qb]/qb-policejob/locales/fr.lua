local Translations = {
    ...
    info = {
        ...
        on_duty = '[E~s~] - Prendre son service',
        off_duty = '[~r~E~s~] - Quitter son service',
        onoff_duty = 'On~s~/~r~Off~s~ Service',
        stash = 'Coffre %{value}',
        delete_spike = '[~r~E~s~] Prendre la Herse',
        close_camera = 'Fermer la caméra',
        bullet_casing = '[G~s~] Douilles %{value}',
        casing = 'Douille',
        blood = 'Sang',
        blood_text = '[G~s~] Sang %{value}',
        fingerprint_text = '[G~s~] Empreinte',
        fingerprint = 'Empreinte digitale',
        store_heli = '[E~s~] Ranger l\'hélicoptère',
        take_heli = '[E~s~] Prendre l\'hélicoptère',
        impound_veh = '[E~s~] - Fourrière',
        store_veh = '[E~s~] - Ranger le véhicule',
        armory = 'Armurerie',
        enter_armory = '[E~s~] Armurerie',
        finger_scan = 'Scan d\'Empreinte Digitale',
        scan_fingerprint = '[E~s~] Scan d\'Empreinte Digitale',
        trash = 'Poubelle',
        trash_enter = '[E~s~] Poubelle',
        stash_enter = '[E~s~] Entrer dans le Casier',
