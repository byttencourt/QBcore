local Translations = {
    ...
    info = {
        ...
        on_duty = '[E~s~] - ﺔﻣﺪﺨﻟﺍ ﻝﻮﺧﺩ',
        off_duty = '[~r~E~s~] - ﺔﻣﺪﺨﻟﺍ ﻦﻣ ﺝﻭﺮﺨﻟﺍ',
        onoff_duty = 'ﺔﻣﺪﺨﻟﺍ ﺔﻟﺎﺣ',
        stash = '%{value}',
        delete_spike = '[~r~E~s~] ﻖﻳﺮﻄﻟﺍ ﻦﻣ ﺔﻟﺍﺯﺇ',
        close_camera = 'Close Camera', --en
        bullet_casing = '[G~s~] %{value} ﺹﺎﺻﺭ ﺎﻳﺎﻘﺑ',
        casing = 'بقايا رصاص',
        blood = 'دم',
        blood_text = '[G~s~] %{value} ﻡﺩ ﺎﻳﺎﻘﺑ',
        fingerprint_text = '[G~s~] ﻊﺒﺻﻹﺍ ﺔﻤﺼﺑ ﺢﺴﻣ',
        fingerprint = 'ﻊﺒﺻﻹﺍ ﺔﻤﺼﺑ',
        store_heli = '[E~s~] ﺝﺍﺮﻏ',
        take_heli = '[E~s~] ﺝﺍﺮﻏ',
        impound_veh = '[E~s~] - ﺓﺯﻮﺠﺤﻤﻟﺍ ﺕﺍﺭﺎﻴﺴﻟﺍ',
        store_veh = '[E~s~] - ﺝﺍﺮﻏ',
        armory = 'Armory',
        enter_armory = '[E~s~] ﺔﺤﻠﺳﻻﺍ ﺔﻧﺰﺧ',
        finger_scan = 'ﻊﺒﺻﻹﺍ ﺔﻤﺼﺑ ﺢﺴﻣ',
        scan_fingerprint = '[E~s~] ﻊﺒﺻﻹﺍ ﺔﻤﺼﺑ ﺢﺴﻣ',
        trash = 'ﺮﻳﻭﺪﺘﻟﺍ ﺓﺩﺎﻋﺍ',
        trash_enter = '[E~s~] ﺮﻳﻭﺪﺘﻟﺍ ﺓﺩﺎﻋﺍ',
        stash_enter = '[E~s~] ﻞﺧﺩﺃ',
