local Translations = {
    ...
    info = {
        ...
        on_duty = '~b~[E~b~] Einstempeln',
        off_duty = '~b~[~r~E~b~] Ausstempeln',
        onoff_duty = 'EIN~s~/~r~AUS~s~ Dienst',
        stash = 'Stash %{value}',
        delete_spike = '~b~[~r~E~b~] Nagelband entfernen',
        close_camera = 'Kamera geschlossen',
        bullet_casing = '~b~[~rb~] Patronenhülse %{value}',
        casing = 'Patronenhülse',
        blood = 'Blut',
        blood_text = '~b~[~rb~] Blut %{value}',
        fingerprint_text = '~b~[~rb~] Fingerabdruck',
        fingerprint = 'Fingerabdruck',
        store_heli = '~b~[~r~E~b~] Helikopter lagern',
        take_heli = '~b~[~r~E~b~] Helikopter nehmen',
        impound_veh = '~b~[~r~E~b~] Fahrzeug beschlagnahmen',
        store_veh = '~b~[~r~E~b~] Fahrzeug speichern',
        armory = 'Waffenkammer',
        enter_armory = '[E~s~] Waffenkammer',
        finger_scan = 'Scannen von Fingerabdrücken',
        scan_fingerprint = '~b~[~r~E~b~] Fingerabdruck scannen',
        trash = 'Müll',
        trash_enter = '~b~[~r~E~b~] Mülleimer',
        stash_enter = '~b~[~r~E~b~] Stash öffnen',
