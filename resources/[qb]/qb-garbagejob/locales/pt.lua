local Translations = {
    ...
    info = {
        ["payslip_collect"] = "E - Folha de Pagamento",
        ["payslip"] = "Pagamento",
        ...
        ["grab_garbage"] = "E - Apanha Saco de Lixo",
        ["stand_grab_garbage"] = "Fica aqui para apanhares um saco de lixo...",
        ["dispose_garbage"] = "E - Despeja o Saco de Lixo",
        ...
        ["store_truck"] =  "E - Guardar Camião do Lixo",
        ["get_truck"] =  "E - Camião do Lixo",
