                    ...
                    if plyDistance < 0.8 then
                        ...
                        if plantData["plantStats"]["health"] > 0 then
                            if plantData["plantStage"] ~= plantData["plantStats"]["highestStage"] then
                                DrawText3Ds(plantData["plantCoords"]["x"], plantData["plantCoords"]["y"], plantData["plantCoords"]["z"], Lang:t('text.sort')..' ' ..plantData["plantSort"]["label"]..' ['..plantData["plantStats"]["gender"]..'] | '..Lang:t('text.nutrition')..' ~b~'..plantData["plantStats"]["food"]..'%  | '..Lang:t('text.health')..' ~b~'..plantData["plantStats"]["health"]..'%')
                                if QBWeed.showStages == true then
                                    DrawText3Ds(plantData["plantCoords"]["x"], plantData["plantCoords"]["y"], plantData["plantCoords"]["z"] - 0.1, Lang:t('text.stage').. ' ~b~' ..plantData["plantStats"]["stage"]..' ' ..Lang:t('text.progress')..' ~b~'..plantData["plantStats"]["progress"]..'%  / ' ..Lang:t('text.highestStage') .. ' ~b~' ..plantData["plantStats"]["highestStage"])
                                end
                            else
