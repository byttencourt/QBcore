local Translations = {
    ...
    info = {
        ...
        taking_over = "جاري",
        pin_code_see = "~b~G - ﺩﻮﻜﻟﺍ ﺽﺮﻋ", -- you need font arabic
        pin_code = "%{value} الكود هو",
        multikeys = "~b~/multikeys [id] - ﺢﻴﺗﺎﻔﻤﻟﺍ ﺀﺎﻄﻋﺍ",
        take_cash = "~b~E - ($%{value}) ﻞﻴﺼﺤﺗ",
        inventory = "~b~H - ﺔﻧﺰﺨﻟﺍ ﺽﺮﻋ",
        take_over = "~b~E - ($5000) ﻲﻟﻮﺗ",
        leave = "~b~E - ﺝﻭﺮﺧ",
    },
    targetInfo = {
        options = "التراب هاوس",
