local Translations = {
    ...
    info = {
        ...
        pin_code_see = "~b~G - See Pin Code",
        pin_code = "Pincode: %{value}",
        multikeys = "~b~/multikeys [id] - To Give Keys",
        take_cash = "~b~E - Take Cash ($%{value})",
        inventory = "~b~H - View Inventory",
        take_over = "~b~E - Take Over ($5000)",
        leave = "~b~E - Leave Traphouse",
    },
    targetInfo = {
