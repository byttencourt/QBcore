local Translations = {
    ...
    info = {
        ...
        pin_code_see = "~b~G - Vezi codul PIN",
        pin_code = "Codul PIN: %{value}",
        multikeys = "~b~/multikeys [id] - Ofera cheile casei conspirative",
        take_cash = "~b~E - Scoate bani ($%{value})",
        inventory = "~b~H - Vezi inventarul",
        take_over = "~b~E - Preluare ostila ($5000)",
        leave = "~b~E - Iesi din casa conspirativa",
    },
    targetInfo = {
