...
Config.Discord = {
    ...
    ["ApplicationId"] = '1198328492559974450', -- The discord application id
    ["IconLarge"] = 'logo_name', -- The name of the large icon
    ["IconLargeHoverText"] = 'Desenvolvendo QBcore', -- The hover text of the large icon
    ["IconSmall"] = 'nino', -- The name of the small icon
    ["IconSmallHoverText"] = 'nino#5012', -- The hover text of the small icon
    ...
    ["Buttons"] = {
        {
            text = 'Github',
            url = 'https://github.com/byttencourt'
        }
    }
}
