local Translations = {
    ...
    info = {
        ...
        blip_name = 'Korv-vagn',
        start_working = '[E~s~] Börja jobba',
        start_work = 'Börja jobba',
        stop_working = '[E~s~] Sluta jobba',
        stop_work = 'Sluta jobba',
        grab_stall = '[G~s~] Greppa vagnen',
        drop_stall = '[G~s~] Släpp vagnen',
        grab = 'Greppa vagnen',
        selling_prep = '[E~s~] Förberedelse av korv [Försäljning: Säljer]',
        not_selling = '[E~s~] Förberedelse av korv [Försäljning: ~r~Säljer inte]',
        sell_dogs = '[7~s~] Sälj %{value} x varmkorvar för $%{value2} / [8~s~] Avböj',
