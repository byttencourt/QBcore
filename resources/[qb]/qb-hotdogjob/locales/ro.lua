...
local Translations = {
    ...
    info = {
        ...
        grab_stall = '[G~s~]-Misca carutul',
        drop_stall = '[G~s~]-Opreste carutul',
        grab = 'Misca carutul',
        prepare = 'Prepara un Hotdog',
        toggle_sell = 'Activeaza/dezactiveaza vanzarea',
        selling_prep = '[E~s~]-Pregateste un hotdog [Vanzare: Activa]',
        not_selling = '[E~s~]-Pregateste un hotdog [Vanzare: ~r~Inactiva]',
        sell_dogs = '[7~s~] Vinde %{value} x HotDogs pentru suma de $%{value2} / [8~s~] Refuza',
