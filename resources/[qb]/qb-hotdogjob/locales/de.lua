local Translations = {
    ...
    info = {
        ...
        start_working = '[E~s~] Starte zu Arbeiten',
        start_work = 'Starte zu Arbeiten',
        stop_working = '[E~s~] Stope zu Arbeiten',
        stop_work = 'Stope zu Arbeiten',
        grab_stall = '[G~s~] Stand nehmen',
        drop_stall = '[G~s~] Stand hinstellen',
        grab = 'Stand nehmen',
        selling_prep = '[E~s~] HotDog herstellen [Status: Verkauf Geöffnet]',
        not_selling = '[E~s~] Hotdog prepare [Status: ~r~Verkauf Geschlossen]',
        sell_dogs = '[7~s~] Verkaufe %{value} x HotDogs für $%{value2} / [8~s~] Ablehnen',
