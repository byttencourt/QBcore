local Translations = {
    ...
    info = {
        ...
        grab_stall = '[G~s~] Grab Stall',
        drop_stall = '[G~s~] Release Stall',
        grab = 'Grab Stall',
        prepare = 'Prepare Hotdog',
        toggle_sell = 'Toggle Selling',
        selling_prep = '[E~s~] Hotdog prepare [Sale: Selling]',
        not_selling = '[E~s~] Hotdog prepare [Sale: ~r~Not Selling]',
        sell_dogs = '[7~s~] Sell %{value} x HotDogs for $%{value2} / [8~s~] Reject',
