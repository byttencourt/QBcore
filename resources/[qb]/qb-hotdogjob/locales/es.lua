local Translations = {
    ...
    info = {
        ...
        grab_stall = '[G~s~] Tomar puesto',
        drop_stall = '[G~s~] dejar puesto',
        grab = 'Puesto de agarre',
        prepare = 'Preparar perro caliente',
        toggle_sell = 'Alternar la venta',
        selling_prep = '[E~s~] preparar perro caliente [Venta: Vendiendo]',
        not_selling = '[E~s~] Hotdog prepare [Sale: ~r~Not Selling]',
        sell_dogs = '[7~s~] Vender %{value} x perros caliente por $%{value2} / [8~s~] Rechazar',
