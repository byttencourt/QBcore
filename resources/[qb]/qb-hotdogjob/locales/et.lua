local Translations = {
    ...
    info = {
        ...
        grab_stall = '[G~s~] Haara Stall',
        drop_stall = '[G~s~] Vabastage Stall',
        grab = 'Haara Stall',
        prepare = 'Valmistage HotDogi',
        toggle_sell = 'Lülitage müümine sisse',
        selling_prep = '[E~s~] Hotdog valmistada [Müük: Müün]',
        not_selling = '[E~s~] Hotdog valmistada [Müük: ~r~Ei müü]',
        sell_dogs = '[7~s~] Müü %{value} x HotDogs hinnaga $%{value2} / [8~s~] Keeldu',
