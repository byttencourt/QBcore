local Translations = {
    ...
    info = {
        ...
        start_working = '[E~s~] Commencer a travailler',
        start_work = 'Commencer a travailler',
        stop_working = '[E~s~] Arrêter de travailler',
        stop_work = 'Arrêter de travailler',
        grab_stall = '[G~s~] Prendre le Stand',
        drop_stall = '[G~s~] Lacher le Stand',
        grab = 'Prendre le Stand',
        selling_prep = '[E~s~] Préparer un Hot-Dogs [Sale: En vente]',
        not_selling = '[E~s~] Préparer un Hot-Dogs [Sale: ~r~Pas en vente]',
        sell_dogs = '[7~s~] Vendre %{value} x Hot-Dogs pour $%{value2} / [8~s~] Rejeter',
