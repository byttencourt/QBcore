local Translations = {
    ...
    info = {
        ...
        start_working = '[E~s~] Começar Trabalho',
        start_work = 'Começar Trabalho',
        stop_working = '[E~s~] Parar Trabalho',
        stop_work = 'Parar Trabalho',
        grab_stall = '[G~s~] Empurrar Stand',
        drop_stall = '[G~s~] Soltar Stand',
        grab = 'Soltar Stand',
        prepare = 'Preparar cachorro-quente',
        toggle_sell = 'Ativar venda',
        selling_prep = '[E~s~] A preparar cachorro [Vendas: Abertas]',
        not_selling = '[E~s~] A preparar cachorro [Vendas: ~r~Fechadas]',
        sell_dogs = '[7~s~] Vender %{value} x Cachorros por %{value2}€ / [8~s~] Rejeitar',
