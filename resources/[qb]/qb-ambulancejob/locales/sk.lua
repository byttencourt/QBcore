local Translations = {
    ...
    info = {
        ...
        request_help = 'STLAČ [~rs~] PRE POŽIADANIE O POMOC',
    ...
    text = {
        ...
        offduty_button = '~r~E - Ísť mimo službu',
        duty = 'On/Off Duty',
        armory_button = 'E - Zbrojnica',
        armory = 'Zbrojnica',
        storeveh_button = 'E - Uložiť vozidlo',
        veh_button = 'E - Vozidlá',
        storeheli_button = 'E - Uložiť helikoptéru',
        heli_button = 'E - Vybrať helikoptéru',
