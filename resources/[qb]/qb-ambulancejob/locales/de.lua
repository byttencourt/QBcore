local Translations = {
    ...
    info = {
        ...
        request_help = 'Drücke [~rs~] für eine hilfeanfrage',
    ...
    text = {
        ...
        offduty_button = '~r~E - Dienst quittieren',
        duty = 'In/Ausser Dienst',
        armory_button = 'E - Waffenschrank',
        armory = 'Waffenschrank',
        storeveh_button = 'E - Verwahre Fahrzeug',
        veh_button = 'E - Fahrzeuge',
        storeheli_button = 'E - Verwahre Helikopter',
        heli_button = 'E - Nimm einen Helikopter',
