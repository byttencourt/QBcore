local Translations = {
    ...
    info = {
        ...
        request_help = 'Paina [~rs~] pyytääksesi apua!',
    ...
    text = {
        ...
        offduty_button = '~r~E - Astu pois vuorosta',
        duty = 'Vuoroon/pois vuorosta',
        armory_button = 'E - Varasto',
        armory = 'Varasto',
        storeveh_button = 'E - Talleta ajoneuvo',
        veh_button = 'E - Ajoneuvot',
        storeheli_button = 'E - Talleta helikopteri',
        heli_button = 'E - Ota ulos helikopteri',
