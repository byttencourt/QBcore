local Translations = {
    ...
    info = {
        ...
        respawn_txt = '~r~%{deathtime} ﻝﻼﺧ ﺕﻮﻤﻟﺍ',
        respawn_revive = '[~r~Hold E] %{holdtime} ﻥﻭﺎﺒﺳﺭ $~r~%{cost}~s~',
        bleed_out = 'ﺔﻴﻧﺎﺛ ~r~%{time} :ﻲﻓ ﻑﺰﻨﺗ ﻑﻮﺳ',
        bleed_out_help = 'ﻚﺗﺪﻋﺎﺴﻣ ﻦﻜﻤﻳ ﻭ ﺔﻴﻧﺎﺛ ~r~%{time} :ﻲﻓ ﻑﺰﻨﺗ ﻑﻮﺳ',
        request_help = '[~rs~] - ﺓﺪﻋﺎﺴﻤﻟﺍ ﺐﻠﻄﻟ',
    ...
    text = {
        ...
        offduty_button = '~r~E - ﺔﻣﺪﺨﻟﺍ ﻦﻣ ﺝﻭﺮﺨﻟﺍ',
        duty = 'ﺔﻣﺪﺨﻟﺍ ﺔﻟﺎﺣ',
        armory_button = 'E - ﺔﻧﺰﺨﻟﺍ',
        armory = 'ﺔﻧﺰﺨﻟﺍ',
        storeveh_button = 'E - ﺝﺍﺮﻐﻟﺍ',
        veh_button = 'E - ﺝﺍﺮﻐﻟﺍ',
        storeheli_button = 'E - ﺝﺍﺮﻐﻟﺍ',
        heli_button = 'E - ﺝﺍﺮﻐﻟﺍ',
