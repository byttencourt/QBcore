local Translations = {
    ...
    info = {
        ...
        respawn_txt = 'RENASCER EM: %{deathtime} Segundos',
        respawn_revive = 'AGUARDE [E] por %{holdtime} SEGUNDOS PARA RENASCER $%{cost}',
        bleed_out = 'VOCÊ VAI SANGRAR EM: %{time} Segundos',
        bleed_out_help = 'VOCÊ VAI SANGRAR EM: %{time} SEGUNDOS, VOCÊ PODE SER AJUDADO',
        request_help = 'PRESSIONE [G] PARA SOLICITAR AJUDA',
