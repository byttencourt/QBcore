local Translations = {
    ...
    info = {
        ...
        drug_offer = "[E] %{bags}x %{drugLabel} per $%{randomPrice}? / [G] Declina l'offerta",
        pick_up_button = "[E] Raccogli",
        knock_button = "[E] Bussa",
        mystery_man_button = "[E] Compra / [G] Aiuta il tuo amico ($5000)",
        other_dealers_button = "[E] Compra / [G] Inizia una missione",
        ...
        deliver_items_button = "[E] %{itemAmount}x %{itemLabel} consegna",
