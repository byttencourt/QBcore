local Translations = {
    ...
    info = {
        ...
        drug_offer = "[E] %{bags}x %{drugLabel} for %{randomPrice} DKK? / [G] Afvis tilbud",
        pick_up_button = "[E] Saml op",
        knock_button = "[E] Bank på",
        mystery_man_button = "[E] Køb / [G] Hjælp din fyr (5000 DKK)",
        other_dealers_button = "[E] Køb / [G] Start en mission",
        ...
        deliver_items_button = "[E] %{itemAmount}x %{itemLabel} aflever",
