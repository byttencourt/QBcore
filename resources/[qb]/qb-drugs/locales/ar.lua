local Translations = {
    ...
    info = {
        ...
        drug_offer = "E - %{bags}x %{drugLabel} = $%{randomPrice} | G - ﺾﻓﺭ", -- you need font arabic
        pick_up_button = "E - ﻊﻤﺟ",
        knock_button = "E - ﻕﺮﻃ",
        mystery_man_button = "E - ﺀﺍﺮﺷ / G - $5000 ﺏ ﻢﻴﻋﺪﺗ",
        other_dealers_button = "E - ﺀﺍﺮﺷ / G - ﺔﻤﻬﻣ ﺔﻳﺍﺪﺑ",
        ...
        deliver_items_button = "E - %{itemAmount}x %{itemLabel} ﻢﻴﻠﺴﺗ",
